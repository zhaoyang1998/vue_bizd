<template>
  ...
  >
    ...
    <el-tooltip content="刷新页面" placement="bottom" :show-after="500">
      <Iconfont
        class="margin_r-15 cursor-pointer"
        size="16px"
        name="refresh"
    ...
    <el-tooltip content="清理缓存" placement="bottom" :show-after="500">
      <Iconfont
        class="margin_r-15 cursor-pointer"
        size="16px"
        name="clear"
    ...
    <el-tooltip content="暗黑模式" placement="bottom" :show-after="500">
      <el-switch
        class="margin_r-15"
        v-model="mode"
    ...
    <el-dropdown trigger="click" @command="dropdownHandle">
      <el-avatar class="cursor-pointer" :src="administrator.avatar">
